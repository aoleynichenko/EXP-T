...
for sym in symmetries:
	...
	t_ccsdt_corr  = Filter("CCSDT correlation energy = ",       -0.092403826589, 1e-7)
	t_ccsdt       = Filter("Total CCSDT energy = ",            -51.200716607789, 1e-7)
	t_e1          = Filter("@    1", -3.3526310131, 1e-7)
	t_e2          = Filter("@    2", -3.2606347294, 1e-7)
	t_e3          = Filter("@    3", -3.2606195724, 1e-7)
	t_e4          = Filter("@    4", -3.2137325584, 1e-7)
	t_e5          = Filter("@    5", -3.2137089337, 1e-7)
