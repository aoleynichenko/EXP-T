...
/*
 * Calculation of model density matrices (built on model vectors).
 */

#include "model_density_matrix.h"
...
void write_model_natural_spinors_formatted(char *natorb_file_name, int sect_h, int sect_p,
 ...
 */
void construct_model_space_density_matrix(
