...
#ifndef CC_FINITE_ORDER_DM_0H2P_H_INCLUDED
#define CC_FINITE_ORDER_DM_0H2P_H_INCLUDED
...
void construct_one_part_active_density_matrix_diagram_0h2p(char *diagram_name, char *irrep_name, int state_number);

void construct_two_part_active_density_matrix_diagram_0h2p(char *diagram_name, char *irrep_name, int state_number);
...
#endif // CC_FINITE_ORDER_DM_0H2P_H_INCLUDED
