 ...
 * @param heff
 */
void write_formatted_heff_file(int sect_h, int sect_p, size_t *block_dims, double complex **heff)
{
    ...
    for (int irep = 0; irep < get_num_irreps(); irep++) {
        ...
        formatted_heff_file_write_block(hefff, arith == CC_ARITH_COMPLEX, irep - first_irrep + 1, ms_size, heff_block);
    }
