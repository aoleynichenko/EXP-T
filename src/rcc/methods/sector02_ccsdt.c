...
{
    timer_new_entry("folded_X3", "Folded contribution to T{0h2p}_3");
...
void sector_0h2p_ccsd_t3()
{
    ...
    t3_const_contrib_to_triples_0h2p(PT_2);
    construct_triples_0h2p(PT_2);
    t3_contrib_to_folded_0h2p(PT_2);
    ...
    t3_contrib_to_doubles_0h2p(PT_2);  // here: T3 contrib to Veff
    closed("x2nw", "veff02_pt3");

    // construction and diagonalization of the effective Hamiltonian
    heff_analysis(0, 2, "veff01_pt3", "veff02_pt3");
...
void sector_0h2p_ccsd_t4()
{
    ...
    t3_contrib_to_doubles_0h2p(PT_3);
    pos = get_stack_pos();
    closed("x2nw", "x");
    restore_stack_pos(pos);
    ...
    // 0h2p
    clear("x3_0");
    t3_const_contrib_to_triples_0h2p(PT_3);
    construct_triples_0h2p(PT_3);
    t3_contrib_to_folded_0h2p(PT_3);
    copy("x3nw", "x3c");
    diveps("x3c");
    copy("t3c_pt3", "t3c");
    copy("s3c_pt3", "s3c");
