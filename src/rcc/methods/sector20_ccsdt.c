 ...
 * This file contains implementation of the CCSDT model.
 *
...
void diag_T3_2h0p_i_jk_c_ab_inv12(int pt_order);
void diag_T3_2h0p_i_jk_c_ab_inv13(int pt_order);

void diag_T3_2h0p_k_ij_a_bc_inv12(int pt_order);
void diag_T3_2h0p_k_ij_a_bc_inv23(int pt_order);

void diag_T3_2h0p_k_ij_c_ab_inv12(int pt_order);
void diag_T3_2h0p_k_ij_c_ab_inv13(int pt_order);

void diag_T3_2h0p_ijk_c_ab_inv12(int pt_order);
void diag_T3_2h0p_ijk_c_ab_inv13(int pt_order);

void diag_T3_2h0p_k_ij_abc_inv12(int pt_order);
void diag_T3_2h0p_k_ij_abc_inv13(int pt_order);
void diag_T3_2h0p_k_ij_abc_inv23(int pt_order);

void diag_T3_2h0p_c_ab_inv12(int pt_order);
void diag_T3_2h0p_c_ab_inv13(int pt_order);

void diag_T3_2h0p_a_bc_inv12(int pt_order);
void diag_T3_2h0p_a_bc_inv13(int pt_order);

void diag_T3_2h0p_abc_inv12(int pt_order);
void diag_T3_2h0p_abc_inv13(int pt_order);
void diag_T3_2h0p_abc_inv23(int pt_order);

void diag_T3_2h0p_ijk(int pt_order);

void diag_T3_2h0p_i_jk(int pt_order);

void diag_T3_2h0p_k_ij(int pt_order);
...
/**
 * calculates next approximation to the T3 cluster operator in the 2h0p Fock space sector.
 */
void construct_triples_2h0p(int pt_order)
{
    timer_new_entry("20-G3", "2h0p -- Triples equations (G3)");
    timer_start("20-G3");

    tmplt("g3nw", "hhhhhp", "000110", "123456", IS_PERM_UNIQUE);

    diag_T3_2h0p_i_jk_c_ab_inv12(pt_order);
    diag_T3_2h0p_i_jk_c_ab_inv13(pt_order);

    diag_T3_2h0p_k_ij_a_bc_inv12(pt_order);
    diag_T3_2h0p_k_ij_a_bc_inv23(pt_order);

    diag_T3_2h0p_k_ij_c_ab_inv12(pt_order);
    diag_T3_2h0p_k_ij_c_ab_inv13(pt_order);

    diag_T3_2h0p_ijk_c_ab_inv12(pt_order);
    diag_T3_2h0p_ijk_c_ab_inv13(pt_order);

    diag_T3_2h0p_k_ij_abc_inv12(pt_order);
    diag_T3_2h0p_k_ij_abc_inv13(pt_order);
    diag_T3_2h0p_k_ij_abc_inv23(pt_order);

    diag_T3_2h0p_c_ab_inv12(pt_order);
    diag_T3_2h0p_c_ab_inv13(pt_order);

    diag_T3_2h0p_a_bc_inv12(pt_order);
    diag_T3_2h0p_a_bc_inv13(pt_order);

    diag_T3_2h0p_abc_inv12(pt_order);
    diag_T3_2h0p_abc_inv13(pt_order);
    diag_T3_2h0p_abc_inv23(pt_order);

    diag_T3_2h0p_ijk(pt_order);

    diag_T3_2h0p_i_jk(pt_order);

    diag_T3_2h0p_k_ij(pt_order);
...
void t3_contrib_to_doubles_2h0p(int pt_order)
{
    timer_new_entry("20-T2-Triples", "2h0p -- Triples contribution to doubles");
    timer_start("20-T2-Triples");
    ...
    // permutation: P(34)
    reorder("h3c", "r1", "124356");
    tmplt("i1", "hhpp", "1000", "3412", NOT_PERM_UNIQUE);
    {
        dg_stack_pos_t pos2 = get_stack_pos();

        // D10b
        reorder("ppgh", "_r1", "3412");
        update("i1", 0.5, "_r1");
        restore_stack_pos(pos2);
    ...
    timer_stop("20-T2-Triples");
}


/**
 * Folded diagrams for the triples equations in the 2h0p sector.
 */
void t3_contrib_to_folded_2h0p(int pt_order)
{
    timer_new_entry("folded_G3", "Folded contribution to T{2h0p}_3");
    timer_start("folded_G3");
    ...
    if (pt_order == PT_INF && cc_opts->cc_model == CC_MODEL_CCSDT_1B_PRIME) {
        ...
        // F7
        reorder("g3c", "r1", "123645");
        reorder("veff20", "r2", "3412");
        mult("r1", "r2", "r3", 2);
...
void diag_T3_2h0p_i_jk_c_ab_inv12(int pt_order)
{
    ...
    if ((pt_order == PT_INF && cc_opts->cc_model > CC_MODEL_CCSDT_3) ||
        ...
        // T5d
        reorder("g3c", "g3c_132", "132465"); // interchange electrons: 2 <-> 3
